---
name: IO-variation_operator_generator._operators_from_response
...
## → Calls
- [[IO-template.DIVERGE_TEMPLATE]]
- [[IO-template.REFINE_TEMPLATE]]
- [[IO-variation_operator_generator._parse_combined_response]]
