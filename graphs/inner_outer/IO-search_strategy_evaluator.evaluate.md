---
name: IO-search_strategy_evaluator.evaluate
...
**File:** `skydiscover/search/evox/database/search_strategy_evaluator.py:127`  
**Kind:** function  
**Layer:** #evox
...
- [[IO-search_strategy_evaluator._check_forbidden_attributes]]
- [[IO-search_strategy_evaluator._error_response]]
- [[IO-search_strategy_evaluator._format_attribute_error]]
- [[IO-search_strategy_evaluator._verify_metrics_preserved]]
